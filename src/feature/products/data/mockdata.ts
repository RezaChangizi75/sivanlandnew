...
export const product: ProductDetails = {
  ...
  specs: [
    ...
    { label: "زمان گیرایش اولیه", value: "۴۵ دقیقه" },
    { label: "زمان گیرایش نهایی", value: "۲۸۰ دقیقه" },
    { label: "وزن", value: "۵۰ کیلوگرم" },
    { label: "جنس بسته بندی", value: "پاکت ۵۰ کیلویی" },
    { label: "موجودی پایه", value: "۱ پاکت" },
    { label: "نوع فروش", value: "عمده" },
  ],
  description: [
    "سیمان پاکتی تیپ ۲ نیما از محصولات باکیفیت کارخانه سیمان آبیک است که مطابق با استانداردهای ایران تولید شده و برای شرایط محیطی با رطوبت متوسط، بتن ریزی عمومی و پروژه های ساختمانی گزینه ای قابل اعتماد است.",
